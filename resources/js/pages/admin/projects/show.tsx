                                ...
                                <Card>
                                    <CardContent className="pt-6">
                                        <ul className="space-y-4">
                                            <li>
                                                <span className="text-sm text-muted-foreground mx-1">Client</span>
                                                <span className="font-medium">{project.client || "N/A"}</span>
                                            </li>
                                            <li>
                                                <span className="text-sm text-muted-foreground mx-1">Project Type</span>
                                                <span className="font-medium">{project.type || "N/A"}</span>
                                            </li>
                                            <li>
                                                <span className="text-sm text-muted-foreground mx-1">Duration</span>
                                                <span className="font-medium">{project.duration || "N/A"}</span>
                                            </li>
                                            <li>
                                                <span className="text-sm text-muted-foreground mx-1">Team Size</span>
                                                <span className="font-medium">{project.teamSize || "N/A"}</span>
                                            </li>
                                            <li>
                                                <span className="text-sm text-muted-foreground mx-1">Role</span>
                            ...
                            {features.map((feature, index) => (
                                <Card key={index} className="overflow-hidden border">
                                    <div className="p-1 bg-primary/10 flex items-center justify-center">
                                        <img
                                            src={feature.image_path? `/storage/${feature.image_path}` : "/placeholder.svg"}
                                            alt={feature.title}
                                            width={80}
                                            height={80}
                                    ...
                                    <CardContent className="pt-6">
                                        <h3 className="text-xl font-bold mb-2 text-muted-foreground">{feature.title}</h3>
                        ...
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            {gallery.map((image, index) => (
                                <div key={index} className="relative aspect-video rounded-lg overflow-hidden border shadow">
                                    <img
                                        src={image.image_path ? `/storage/${image.image_path}` : "/placeholder.svg"}
